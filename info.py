...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+y6JmJ2f1LCYxOTVl')  # Support group link (make sure bot is admin)
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'royalbomma2_files') # Collection name (default: dreamcinezone_files)
